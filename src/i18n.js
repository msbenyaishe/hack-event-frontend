...
const resources = {
  en: {
    translation: {
      ...
      "confirm_finish_hackathon": "Are you sure you want to finish the hackathon? This cannot be undone.",
  ...
  fr: {
    translation: {
      ...
      "confirm_finish_hackathon": "Êtes-vous sûr de vouloir terminer le hackathon ? Cette action est irréversible.",
  ...
  ar: {
    translation: {
      ...
      "confirm_finish_hackathon": "هل أنت متأكد من إنهاء الهاكاثون؟ لا يمكن التراجع عن هذا الإجراء.",
